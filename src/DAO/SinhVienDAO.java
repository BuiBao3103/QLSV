...
public class SinhVienDAO {
    ...
    public ArrayList<SinhVienDTO> get() {
...
//            String query = "select * from SinhVien where MaKhoa=?";//+
    ...
    public int getTrangThaiByMaTk(int MaTK) {
        ...
        try {
            ...
            while (rs.next()) {
                int trangThai = rs.getInt("TrangThai");
                SinhVienDTO sv = new SinhVienDTO(trangThai);
    ...
    public void add(SinhVienDTO sv) {
        con = ConnectionDB.getConnection();
        try {
    ...
    public void update(String maSV, SinhVienDTO sv) {
        con = ConnectionDB.getConnection();
        try {
...
//            pstm.setString(1, year);//+
    ...
    public ArrayList<SinhVienDTO> getByNumberOfPage(int page) { // hàm này lấy dssv theo số trang đang xét
        con = ConnectionDB.getConnection();
...
//            String query = "select * from SinhVien where MaKhoa=?";//+
    ...
    public ArrayList<SinhVienDTO> getDeletedStudentByNumberOfPage(int page) { // hàm này lấy dssv theo số trang đang xét
        con = ConnectionDB.getConnection();
        int nextStudent = (page - 1) * 20; // page 1 sẽ lấy từ 1->100 svien, page 2 sẽ lấy từ 101->200 svien
        ArrayList<SinhVienDTO> dssv = new ArrayList<>();//+
        try {
//            String query = "select * from SinhVien where MaKhoa=?";//+
    ...
    public ArrayList<SinhVienDTO> getByHoTen(String HoTen) { // hàm này lấy dssv theo họ tên truyền vào
        con = ConnectionDB.getConnection();
        ArrayList<SinhVienDTO> dssv = new ArrayList<>();//+
        try {
//            String query = "select * from SinhVien where MaKhoa=?";//+
...
//            System.out.println(query);
    ...
    public ArrayList<SinhVienDTO> getByMaSV(String MaSV) { // hàm này lấy dssv theo Mã SV truyền vào
        con = ConnectionDB.getConnection();
        ArrayList<SinhVienDTO> dssv = new ArrayList<>();//+
        try {
//            String query = "select * from SinhVien where MaKhoa=?";//+
...
//            System.out.println(query);
    ...
    public ArrayList<SinhVienDTO> getByNganh(String TenNganh) { // hàm này lấy dssv theo Mã SV truyền vào
        con = ConnectionDB.getConnection();
        ArrayList<SinhVienDTO> dssv = new ArrayList<>();//+
        try {
//            String query = "select * from SinhVien where MaKhoa=?";//+
...
//            System.out.println(query);
    ...
    public ArrayList<SinhVienDTO> getByCondition(String CondiTion, String conditionName) { // hàm này lấy dssv theo mã khoa truyền vào
        con = ConnectionDB.getConnection();
        ArrayList<SinhVienDTO> dssv = new ArrayList<>();//+

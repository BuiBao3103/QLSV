...
public class DieuKienDAO {
    ...
    public ArrayList<DieuKienDTO> get() {
        con = ConnectionDB.getConnection();
        ArrayList<DieuKienDTO> dsdk = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                ...
                DieuKienDTO dk = new DieuKienDTO(maHP, maHP_truoc);
                dsdk.add(dk);
            }
    ...
    public void add(DieuKienDTO dk) {
        con = ConnectionDB.getConnection();
        try {
    ...
    public void update(String maHP, String maHP_truoc, DieuKienDTO dk) {
        con = ConnectionDB.getConnection();
        try {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<DieuKienDTO> dsdk = dkd.get();
        dsdk.forEach(kq -> System.out.println(kq.toString()));
        DieuKienDTO dk = new DieuKienDTO("866103", "866102");
        dkd.add(dk);

...
public class NQ_CTQDAO {
    ...
    public ArrayList<NQ_CTQDTO> get() {
        con = ConnectionDB.getConnection();
        ArrayList<NQ_CTQDTO> dsnq_ctq = new ArrayList<>();//+
        try {
            ...
            while (rs.next()) {
                ...
                NQ_CTQDTO nq_ctq = new NQ_CTQDTO(maNhomQuyen, maQuyen);
                dsnq_ctq.add(nq_ctq);//+
            }
    ...
    public void add(NQ_CTQDTO nq_ctq) {
        con = ConnectionDB.getConnection();
    ...
    public void update(String maNhomQuyen, String maQuyen, NQ_CTQDTO nq_ctq) {
        con = ConnectionDB.getConnection();

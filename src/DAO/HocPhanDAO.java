...
public class HocPhanDAO {
    ...
    public ArrayList<HocPhanDTO> get() {
        con = ConnectionDB.getConnection();
        ArrayList<HocPhanDTO> dshp = new ArrayList<>();//+
        try {
            ...
            while (rs.next()) {
                ...
                HocPhanDTO hp = new HocPhanDTO(maHP, tenHP, tinChi, chuyenBiet, phanTramQuaTrinh, maKhoa, maNganh);
                dshp.add(hp);//+
            }
    ...
    public void update(String maHP, HocPhanDTO hp) {
        con = ConnectionDB.getConnection();
        try {
    ...
    public HocPhanDTO getByMaHP(String mahp){
        con = ConnectionDB.getConnection();
        HocPhanDTO hp = null;
        try {
            ...
            while (rs.next()) {
                ...
                String maKhoa = rs.getString("MaKhoa");
                String maNganh = rs.getString("maNganh");
                hp = new HocPhanDTO(maHP, tenHP, tinChi, chuyenBiet, phanTramQuaTrinh, maKhoa, maNganh);
            }
        } catch (SQLException e) {
        } finally {
            ConnectionDB.closeConnection(con, pstm);

...
public class LopDAO {
    ...
    public ArrayList<LopDTO> get() {
        ArrayList<LopDTO> dsl = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                LopDTO l = new LopDTO(maLop,maNganh,maCoVan,soLuong);
                dsl.add(l);
            }
    ...
    public void update(String maLop, LopDTO l) {
        con = ConnectionDB.getConnection();
        try {
    ...
    public static void main(String[] args) {
         ArrayList<LopDTO> dsl = new LopDAO().get();
